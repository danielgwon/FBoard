...
You will be writing a (rather primitive) online store simulator.  It will have three classes: Product, Customer and Store.  Here are descriptions of methods for the three classes:

**Product:**

A Product object represents a product with an ID code, title, description, price and quantity available.

* init method - takes as parameters five values with which to initialize the Product's id_code, title, description, price, and quantity_available.  You should make these data members private
...
* init method - takes as parameters three values with which to initialize the Customer's name, account_ID, and whether the customer is a premium_member.  You should make these data members private
you decide how to represent a Customer's cart, but it should also be private
...
* **you** decide how to represent a Store's inventory and members, but they should be private
